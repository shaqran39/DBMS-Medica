...
<body class="french-pink">
    ...
    <!-- Collections -->
    <div class="container">
        <ul class="collection maya-blue" id="caregiver-history">
            ...
            <li class="collection-item avatar">
                <div class="row">
                    ...
                    <div class="col s7 xl6 valign-wrapper">
                        ...
                        <i class="fas fa-user-nurse small circle"></i>
                        <p>
                            Caregiver Name
                            <br>
    ...
    <script>
        ...
        class Caregiving
        {
            constructor()
            {
                this.nurseName="Mike Uniform November Sierra";
                this.nurseRank="" /*Put some freakin rank here in the quotation*/;
        ...
        let collection = document.querySelector('#caregiver-history');
        array.forEach(elem => {
            let str =
            `
            <li class="collection-item avatar">
                <div class="row">
                    ...
                    <div class="col s5 xl6 valign-wrapper">
                        <p>
                            ...
                            <br>
                            Status: <!-- ${obj.status} -->
                            ${( Math.random() >= 0.5 ) ? "Completed" : "Ongoing" /* এই যে ব্রাদার, আপনার কি মাথা ব্যথা করছে? */}
                        </p>
                    </div>
                </div>
            </li>
