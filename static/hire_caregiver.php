                    ...
                    <div class="col-xl-12">
                        <div class="card shadow-sm">
                            <div class="card-body bg-light shadow-sm">
                                <h4 class="text-dark card-title" style="padding: 20px;color: #ffffff;font-size: 30px;">Hire Caregiver</h4>
                                <form action="./hiring_fin.php" method="POST">
                                    <div class="row">
                                        <div class="col">
                                            <p>Caregiver ID<input name="caregiver_id" required type="text" style="width: 100%;"></p>
                                            <p>Caregiver Name<input name="caregiver_name" required type="text" style="width: 100%;"></p>
                                        </div>
                                    </div>
                                    <button name="hire_caregiver" type="submit" class="btn btn-primary">Hire Caregiver</button>
                                </form>
                            </div>
                        </div>
                    </div>
