                    ...
                    <div class="col-xl-12">
                        <div class="card shadow-sm">
                            <div class="card-body bg-light shadow-sm">
                                <h4 class="text-dark card-title" style="padding: 20px;color: #ffffff;font-size: 30px;">Hire Doctor</h4>
                                <form action="./hiring_fin.php" method="POST">
                                    <div class="row">
                                        <div class="col">
                                            <p>Doctor_id<input name="doctor_id" required type="text" style="width: 100%;"></p>
                                            <p>Doctor Name<input name="doctor_name" required type="text" style="width: 100%;"></p>
                                        </div>
                                    </div>
                                    <button name="hire_doctor" type="submit" class="btn btn-primary">Hire Doctor</button>
                                    <form>
                            </div>
                        </div>
                    </div>
