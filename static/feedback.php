    ...
    <div class="container" style="padding: 30px;">
        <div class="col">
            <div class="row" style="margin-top: 10px;margin-bottom: 10px;">
                ...
                <div class="col-xl-12">
                    <form action="./feedback_fin.php" method="POST">
                        <div class="card shadow-sm">
                            <div class="card-body bg-light shadow-sm">
                                ...
                                <div class="card" style="margin: 15px;">
                                    <div class="card-body shadow" style="height: 125px;">
                                        <!--Comment-->
                                        <h6 class="text-muted card-subtitle mb-2">Comment</h6>
                                        <div style="padding-top: 15px;">
                                            <textarea name="comment1" style="width: 100%; height:100%" placeholder="Write your comment here"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <button name="save_feedback" class="btn btn-primary" type="submit" style="width: 150px;margin: 0px;padding: 4px;">Feedback</button>
                            </div>
                        </div>
                    </form>
                </div>
